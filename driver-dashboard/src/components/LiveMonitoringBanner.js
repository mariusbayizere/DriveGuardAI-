...
/**
 * Top-of-page banner shown when Python monitoring is active.
 *
 * @param {{ monitoring_active: boolean, current_session?: { driver_id, vehicle_id, trip_id } }} pythonStatus
  ...
  return (
    ...
    >
      ...
      <span style={{ fontSize: isMobile ? 12 : 13, fontWeight: 600, color: '#16a34a', flex: 1 }}>
        Live Monitoring Active — Driver {driver_id}
        &nbsp;·&nbsp; Vehicle {vehicle_id}
        &nbsp;·&nbsp; Trip {trip_id}
      </span>
    </div>
